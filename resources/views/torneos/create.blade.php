    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form class="grid gap-8 grid-cols-1" @if($torneo->id)
                    action="{{ route('torneo.update', ["torneo" => $torneo->id ]) }}" @else
                    action="{{ route('torneo.store') }}" @endif enctype="multipart/form-data" method="POST">
                    @if($torneo->id) {{ method_field("PUT") }} @endif
                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            ...
                            <div class="grid gap-6">
                                <div class="col-span-3 sm:col-span-2">
                                    <label for="estado_torneo" class="block text-sm font-medium text-gray-700">
                                        Estado
                                    </label>
                                    <div class="mt-1 flex rounded-md shadow-sm">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <div class="space-y-1 text-center">
                                            @if ($torneo->id)
                                                <img class="w-28" src="{{ asset("$torneo->trofeo_image") }}" />
                                            @else
                                         ...
                                         <div class="flex text-sm text-gray-600">
                                            ...
                                            <label for="trofeo_image"
                                                class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                                <span>Upload a file</span>
                                                <input id="trofeo_image" name="trofeo_image" type="file" class="sr-only">
                                            </label>
