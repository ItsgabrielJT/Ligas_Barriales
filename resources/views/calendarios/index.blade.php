...
@section('button-add')
    ...
    <a href="{{ route('calendario.create', ['torneo'=>$torneo]) }}"
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <div
                                            ...
                                            <a
                                                href="{{ route('calendario.edit', ['calendario' => $byr->id]) }}">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <form method="POST" action="{{ route('calendario.destroy', ['calendario' => $byr->id]) }}"
                                                class="inline">
                                                @csrf
                                                {{ method_field('DELETE') }}

                                                <a href="{{ route('calendario.destroy', ['calendario' => $byr->id]) }}"
